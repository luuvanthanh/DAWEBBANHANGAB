    ...
    <div class="container">
        ...
        @if (!Auth::user())
            <div class="col-lg-8 col-xlg-9 col-md-7">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('postRegister') }}" method="POST" class="form-horizontal form-material"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label class="col-md-12">Full Name</label>
                                <div class="col-md-12">
                                    <input name="name" placeholder="Enter name" value="{{ old('name') }}" type="text"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="email" placeholder="example@admin.com" value="{{ old('email') }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input value="" name="password" value="{{ old('password') }}" type="password"
                                        value="password" class="form-control form-control-line">
                                    @error('password')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input value="" name="password_confirmation"
                                        value="{{ old('password_confirmation') }}" type="password" value="password"
                                        class="form-control form-control-line">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <select name="id_country" value="{{ old('id_country') }}"
                                        class="form-control form-control-line">
                                        @if (!empty($countries))
                                ...
                                <tr>
                                    ...
                                    @foreach ($images as $img)
                                        <td class="cart_product">
                                            <a href=""><img style="width: 30%"
                                                    src="{{ asset('upload/product/' . $item['user_id'] . '/' . $img . '') }}"
                                                    alt=""></a>
                                        </td>
                                        @php
                                            break;
